  ...
  return (
    <button
      className={classNames(
        "inline-flex items-center justify-center rounded-md border text-center text-sm leading-none shadow-sm transition-shadow focus:border-transparent focus:outline-none focus:ring-2 focus:ring-brand",
        size === "sm" && "h-6 space-x-1 px-2",
        size === "md" && "h-8 space-x-1.5 px-3",
        size === "lg" && "h-10 space-x-2 px-4",
        props.primary
